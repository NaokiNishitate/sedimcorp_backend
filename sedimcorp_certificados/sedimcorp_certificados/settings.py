"""
Configuración principal del proyecto SEDIMCORP Certificados.
"""
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-do(ct98bqgm1rb=^t&y1b(i1agvi#p9h_%_-h*=icq6xoyk&qp')
...
ROOT_URLCONF = 'sedimcorp_certificados.urls'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'sedimcorp_db'),
